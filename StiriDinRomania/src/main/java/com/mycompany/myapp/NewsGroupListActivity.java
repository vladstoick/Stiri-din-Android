 ...
 * lead to a {@link NewsGroupDetailActivity} representing
 * item details. On tablets, the activity presents the list of items and
 * item details side-by-side using two vertical panes.
 * <p>
 * The activity makes heavy use of fragments. The list of items is a
 * {@link NewsGroupListFragment} and the item details
 * (if present) is a {@link NewsGroupDetailFragment}.
 * <p>
 * This activity also implements the required
 * {@link NewsGroupListFragment.Callbacks} interface
 * to listen for item selections.
 */
public class NewsGroupListActivity extends FragmentActivity
    ...
    /**
     * Callback method from {@link NewsGroupListFragment.Callbacks}
    ...
    public void onItemSelected(String id) {
        if (mTwoPane) {
            ...
            arguments.putString(NewsGroupDetailFragment.ARG_ITEM_ID, id);
            ...
            detailIntent.putExtra(NewsGroupDetailFragment.ARG_ITEM_ID, id);
