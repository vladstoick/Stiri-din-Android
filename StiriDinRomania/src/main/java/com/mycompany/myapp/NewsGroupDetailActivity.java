 ...
 * more than a {@link NewsGroupDetailFragment}.
 */
public class NewsGroupDetailActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            arguments.putString(NewsGroupDetailFragment.ARG_ITEM_ID,
                    getIntent().getStringExtra(NewsGroupDetailFragment.ARG_ITEM_ID));
